...
SELECT catergory, COUNT(*) FROM analytics
GROUP BY category;
...
-- 5. Find the app that has the most reviews with a rating greater than equal to 4
SELECT * FROM analytics
WHERE rating >= 4.8 
ORDER BY reviews DESC
LIMIT 1;
...
SELECT SUM(reviews) AS "All the Revviews" from analytics;

-- 14. Find all the categories that have more than 300 apps in them.
SELECT cateogry FROM analytics
GROUP BY category
HAVING COUNT(*) > 300;
